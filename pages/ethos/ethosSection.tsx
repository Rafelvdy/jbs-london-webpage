        ...
        {values.map((value, i) => {
          ...
          return (
            <div
              ...
              } ${isTextOnly ? "md:grid-cols-2" : ""}`}
            >
              {value.image ? (
                value.imageFit === "contain" ? (
                  <div className="relative w-full max-w-[540px] mx-auto aspect-[4/3] overflow-hidden">
                    <Image
                      src={value.image}
                      alt={value.title}
                      fill
              ...
              <div className={`flex flex-col gap-4 ${isTextOnly ? "md:col-span-2" : ""}`}>
